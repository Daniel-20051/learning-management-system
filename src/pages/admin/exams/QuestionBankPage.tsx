...
const QuestionBankPage = () => {
  ...
  useEffect(() => {
    ...
    const loadQuestions = async () => {
      setLoading(true);
      try {
        const response = await api.GetBankQuestions(Number(courseId), currentPage, pagination.limit);
        ...
        // So response.data = { status, code, message, data, pagination }
        // And response.data.data = the array of questions
        ...
        if (Array.isArray(questionsData)) {
          ...
          // Single question object - wrap it in array
          questionsArray = [questionsData];
        }
        ...
        if (paginationData) {
          ...
          // If no pagination data, set based on questions array length
          setPagination(prev => ({
            ...prev,
